...
let textStyleMap = new Map();
let totalIds = textStyleIds.currentTextIds.length;
for (var i = 0; i < totalIds; i++) {
    let currentTextId = textStyleIds.currentTextIds[i];
    let newTextId = textStyleIds.newTextIds[i];
    if (currentTextId.key === newTextId.key) {
        textStyleMap.set(currentTextId.textStyleId, newTextId.textStyleId);
    }
    else {
        console.error("Text style key mismatch:" + currentTextId.key + ", " + newTextId.key);
    }
}
function changeFont() {
    const nodes = figma.currentPage.selection;
    changeTextStyleForNodes(nodes);
...
function changeTextStyleForNodes(nodes) {
    for (const node of nodes) {
        if ("textStyleId" in node) {
            if (textStyleMap.has(node.textStyleId)) {
                node.textStyleId = textStyleMap.get(node.textStyleId);
            }
            else {
...
//#sourceMappingURL=data:application/json;base64,
